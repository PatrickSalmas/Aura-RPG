...
public:
	...
	void SpellGlobeSelected(const FGameplayTag& AbilityTag, bool DeselectingSpellGlobe);
	...
	void OnAbilityEquipped(const FGameplayTag& AbilityTag, const FGameplayTag& StatusTag, const FGameplayTag& SlotTag,
